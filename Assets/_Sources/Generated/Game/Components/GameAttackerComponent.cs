...
public partial class GameEntity {
    ...
    public void AddAttacker(GameEntity newAttacker, float newDamage) {
        var index = GameComponentsLookup.Attacker;
        var component = CreateComponent<AttackerComponent>(index);
        component.attacker = newAttacker;
        component.damage = newDamage;
        AddComponent(index, component);
    }

    public void ReplaceAttacker(GameEntity newAttacker, float newDamage) {
        var index = GameComponentsLookup.Attacker;
        var component = CreateComponent<AttackerComponent>(index);
        component.attacker = newAttacker;
        component.damage = newDamage;
